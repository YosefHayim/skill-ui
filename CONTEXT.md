...
- **Pure render core** — `components/` (shared pieces) compose into `templates/` (gallery pages); `render()` turns a template tree into a full HTML-document string. No I/O here.
